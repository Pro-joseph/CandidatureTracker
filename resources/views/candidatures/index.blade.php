    ...
    @forelse($candidatures as $candidature)
        ...
        @endif
                        ...
                        <tr>
                            ...
                            <td style="white-space:nowrap;">{{ \Carbon\Carbon::parse($candidature->date_candidature)->format('d/m/Y') }}</td>
                            <td>
                            ...
                            <td style="white-space:nowrap;">
                                <div style="display:flex;align-items:center;gap:6px;">
                                    <a href="{{ route('candidatures.show', $candidature) }}"
                                       class="btn btn-secondary btn-sm btn-icon" title="Voir">
                                    ...
                                    <a href="{{ route('candidatures.edit', $candidature) }}"
                                       class="btn btn-secondary btn-sm btn-icon" title="Modifier">
                                        <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24">
